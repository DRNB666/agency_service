package com.turing.code.common.generator.util;
...
public class Generator {
     ...
     */
    private final static String[] TABLE_NAME = new String[]{"user_order"};
    /**
     * 主键生成策略
     */
